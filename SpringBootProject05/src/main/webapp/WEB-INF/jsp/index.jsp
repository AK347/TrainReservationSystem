...
<!-- <a class="submitBtn " href="index1.html"><input type="submit" value="login"></a>
 ...
 <a class="submitBtn " href="/gettrains"><input class="submitBtn" type="submit" name="submit" value="login"></a>
 <a class="submitBtn admin_login" href="/admin_login">Admin Login</a>
 
 </div>
</form>
<form action="/gettrains" >
 <a class="submitBtn admin_login" href="/gettrains">Admin </a>
</form>
</div>
</section>
</body>
